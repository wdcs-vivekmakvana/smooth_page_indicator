...
class SmoothPageIndicator extends StatefulWidget {
  ...
  /// The preload page view controller
  ...
  /// Default constructor
  const SmoothPageIndicator.preload({
    Key? key,
...
class _SmoothPageIndicatorState extends State<SmoothPageIndicator> with _SizeAndRotationCalculatorMixin {
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      animation: widget.controller ?? widget.preloadController!,
  ...
  double get _offset {
    try {
      if (widget.preloadController != null) {
        var offset = widget.preloadController!.page ?? widget.preloadController!.initialPage.toDouble();
      ...
      if (widget.preloadController != null) {
        return widget.preloadController!.initialPage.toDouble();
      }
